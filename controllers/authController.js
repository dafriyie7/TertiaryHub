...
// @route GET /auth/contact-us
// @access Public
const renderContact = (req, res) => {
    res.render('contact-us');
};

// @desc Render Course Finder Page
// @route GET /auth/find-course
// @access Public
const renderCourseFinder = (req, res) => {
    res.render('course-finder');
};

// @desc Render Result Checker Page
// @route GET /auth/check-results
// @access Public
const renderResultChecker = (req, res) => {
    res.render('results-checker');
};

// @desc Render Tertiaries Page
// @route GET /auth/tertiaries
// @access Public
const renderTertiaries = (req, res) => {
    res.render('tertiaries');
};
